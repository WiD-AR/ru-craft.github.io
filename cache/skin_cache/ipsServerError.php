...
<html xml:lang="ru" lang="ru" xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Ошибка при работе с {$name}</title>
		<style type='text/css'>
	...
	<body id='ipboard_body'>
		...
		<div id='content'>
			<div class='message error'>
				Возникла проблема при работе с SQL сервером:
				<p class='message unspecific'>$errorMessage</p>
				<p class='desc'>
					Данная проблема не является ошибкой внутри IP.Board и скорее всего связана с проблемами на вашем SQL сервере. Постарайтесь сообщить об этой проблеме вашему хостинг-провайдеру.
				</p>
			</div>
			
			<p class='message unspecific footer'>
				&laquo;<a href='/index.php' title='На главную'>Вернуться на главную страницу</a>
			</p>
		</div>
	</body>
</html>
