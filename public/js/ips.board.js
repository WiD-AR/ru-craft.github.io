...
_idx.prototype.board = {
	...
	*/
	...
	setUpSideBarBlocks: function()
	{
		...
		//ipb.board.resetSideBarHideOrNot(true);
	},
	...
	toggleSideBarBlock: function( e, elem )
	{
		...
		//ipb.board.resetSideBarHideOrNot();
	}
	
	/*resetSideBarHideOrNot: function( fromInit )
	{
		if ( ipb.board.count_hidden >= ipb.board.count_sbars )
		{
			...
			//$('categories').addClassName('no_sidebar');
		...
		else
		{
			...
			//$('categories').removeClassName('no_sidebar');
		}
	}*/
};
