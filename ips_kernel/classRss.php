...
{	
	...
	public function parseFeedFromData( $data )
	{
		...
		{
			$this->errors[] = sprintf("Ошибка XML: %s в строке %d",  xml_error_string( xml_get_error_code($xml_parser) ), xml_get_current_line_number($xml_parser) );
		}
