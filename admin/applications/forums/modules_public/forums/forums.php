 ...
 * IP.Board v3.3.1
 * Forum Viewing
 * Last Updated: $Date: 2012-04-04 11:52:51 -0400 (Wed, 04 Apr 2012) $
 * </pre>
 *
...
class public_forums_forums_forums extends ipsCommand
{
	...
	protected function _generateActiveUserData()
	{
		...
		$users = $sessionClass->getUsersIn( 'forums', array( 'skipParsing' => true, 'addWhere' => array( "s.location_2_type='forum'", "s.location_2_id={$this->forum['id']}", "s.in_error=0" ) ) );;
