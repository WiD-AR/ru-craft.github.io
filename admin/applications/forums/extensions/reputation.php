			...
			return array( 'type'   => 'pid',
						  ...
						  'inner'  => array( 'select'   => 'p.pid',
						  					...
						  					'add_join' => array( array( 'select' => '',
						  												'from'   => array( 'topics' => 't' ),
						  												'where'  => 't.tid=p.topic_id AND t.approved=1 AND ' . ( empty( $allowedForumIDs ) ? '1=0' : ipsRegistry::DB()->buildWherePermission( $allowedForumIDs, 't.forum_id', FALSE ) ) ) ) ),
