 ...
 * IP.Board v3.3.1
 * Moderator actions
 * Last Updated: $Date: 2012-04-02 09:59:22 -0400 (Mon, 02 Apr 2012) $
 * </pre>
...
class classPost
{
		...
		try
		{
			...
			$_like->sendNotifications(
				...
				array(
					...
					'email_only_subject'	=> sprintf( $this->lang->words['subject__subs_with_post.emailOnly'], $topic['title'] ), # This generic email subject allows clients to nest
	...
	protected function addTopicToTracker( $tid=0 )
	{
		...
		{			
			...
			if ( $this->getSettings('enableTracker') )
			{
