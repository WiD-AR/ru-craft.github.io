 ...
 * IP.Board v3.3.1
 * Forum RSS Import
 * Last Updated: $Date: 2012-03-14 09:32:54 -0400 (Wed, 14 Mar 2012) $
 * </pre>
 *
		...
		while( $row = $this->DB->fetch( $outer ) )
		{
			...
			{				
				...
				if ( ! $row['rss_import_allow_html'] )
				{
					...
					$post_content = IPSText::getTextClass('bbcode')->preDbParse( $editor->switchContent( $topic_item['content'], true ) );
				}
				else
				{
