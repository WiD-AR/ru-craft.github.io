 ...
 * IP.Board v3.3.1
 * Member list
 * Last Updated: $Date: 2012-01-25 11:58:39 -0500 (Wed, 25 Jan 2012) $
 * </pre>
 *
...
class public_members_list_view extends ipsCommand
{
	...
	public function doExecute( ipsRegistry $registry )
	{
		...
		{
			$this->request[$in] = !empty($this->request[ $in ]) ? $this->request[ $in ] : '';
			...
			else if ( in_array( $in, $dates ) and $inbit )
			{
				...
				{	
					...
					$time_int = mktime( 23, 59, 59, $_tmp[1], $_tmp[0], $_tmp[2] );
				}
				else
				{
