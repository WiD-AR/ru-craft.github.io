 ...
 * $LastChangedDate: 2012-04-04 11:41:16 -0400 (Wed, 04 Apr 2012) $
 * @version		v3.3.1
 * $Revision: 10556 $
 */
...
class admin_core_applications_applications extends ipsCommand
{
	...
	public function moduleRecache()
	{
		...
		$this->DB->build( array( 'select' => 'm.*', 'from' => array( 'core_sys_module' => 'm' ), 'where' => 'm.sys_module_visible=1', 'order' => 'a.app_position, m.sys_module_position ASC', 'add_join' => array( array( 'select' => 'a.*', 'from' => array( 'core_applications' => 'a' ), 'where' => 'm.sys_module_application=a.app_directory', 'type' => 'inner' ) ) ) );
...
XML;
	...
	public function applicationSave( $type = 'add' )
	{
		...
		if ( ! $app_enabled && in_array( $app_directory, array( 'core', 'forums', 'members' ) ) )
		{
	...
	public function applicationsMenuDataRecache()
	{
		...
		$this->DB->build( array( 'select' => '*', 'from' => 'core_sys_module', 'where' => 'sys_module_visible=1', 'order' => 'sys_module_position ASC' ) );
		$this->DB->execute();
