...
class admin_core_help_quickhelp extends ipsCommand
{
	...
	private function _redirect( $id )
	{
		...
		{
			case 'docs':
				$url = "http://external.iblink.ru/docs-ipb";
			break;
			
			case 'resources':
				$url = "http://external.iblink.ru/forums";
			break;
			
			case 'contact':
				$url = "http://external.iblink.ru/contact";
			break;
			
			case 'features':
				$url = "http://external.iblink.ru/suggestfeatures";
			break;
			
			case 'bugs':
				$url = "http://external.iblink.ru/bugtrack";
			break;
			
			default:
			case 'support':
				$url = "http://external.iblink.ru/clientarea";
			break;
		}
