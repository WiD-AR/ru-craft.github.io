 ...
 * Last Updated: $LastChangedDate: 2012-01-30 11:39:12 -0500 (Mon, 30 Jan 2012) $
 * </pre>
 *
 * @author 		$Author: mark $
...
class admin_core_tools_performance extends ipsCommand
{
	 ...
	 * @var		array
	 */
	protected $settingsEnable		= array( 'live_search_disable', 'no_au_forum', 'no_au_topic', 'disable_summary', 'topic_marking_noquery' );
