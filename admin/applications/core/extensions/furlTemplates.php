 ...
 * Last Updated: $Date: 2012-03-06 10:30:21 -0500 (Tue, 06 Mar 2012) $
 * </pre>
 *
...
'findcomment'  	   => array( 'app'		     => 'core',
						     ...
						     'in'            => array( 'regex'   => "#/findComment/(\S+?-\S+?)/(\d+?)-(\d+?)$#i",
											           'matches' => array( array( 'app', 'core' ), array( 'module', 'global' ), array( 'section', 'comments' ), array( 'do', 'findComment' ), array( 'fromApp', '$1' ), array( 'parentId', '$2' ), array( 'comment_id', '$3' ) ) ) ),											
