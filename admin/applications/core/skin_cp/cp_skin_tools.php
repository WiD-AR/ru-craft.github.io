 ...
 * IP.Board v3.3.1
 * ACP Tools skin file
 * Last Updated: $Date: 2012-03-28 17:01:07 -0400 (Wed, 28 Mar 2012) $
 *
...
if ( count( $cacheContent ) )
{
	...
	<div class='acp-box'>
		...
		<td>
					<strong>{$cacheContent['cachedSigs']['count']}</strong> из <strong>{$cacheContent['members']['count']}</strong> signatures ({$cacheContent['sigPercent']}%)
		</td>
