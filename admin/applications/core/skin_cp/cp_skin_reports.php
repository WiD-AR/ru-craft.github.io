 ...
 * Last Updated: $Date: 2011-12-11 19:46:05 -0500 (Sun, 11 Dec 2011) $
 * </pre>
 *
...
<div class='section_title'>
	...
	<ul class='context_menu'>
		<li>
			<a href='{$this->settings['_base_url']}&amp;app=core&amp;module=settings&amp;section=settings&amp;do=setting_view&amp;conf_title_keyword=warnsetup'>
...
<div class="acp-box">
    ...
    <table class="ipsTable">
        <tr>
            <td width='40%'><strong>{$this->lang->words['r_totalreports']}</strong></td>
            <td>{$content['reports_total']}</td>
        </tr>
        <tr>
            <td><strong>{$this->lang->words['r_totalcomments']}</strong></td>
            <td>{$content['comments_total']}</td>
        </tr>
        <tr>
            <td><strong>{$this->lang->words['r_activeplugins']}</strong></td>
            <td>{$content['active_plugins']} / {$content['total_plugins']}</td>
        </tr>
    </table>
</div>
<br />
<div class="acp-box">
    ...
    <table class="ipsTable">
        <tr>
            <td class='center'>
                <img src='{$this->settings['base_url']}&amp;{$this->form_code}&amp;do=chart_report_stats' />
                <img src='{$this->settings['base_url']}&amp;{$this->form_code}&amp;do=chart_top_moderator' />
            </td>
        </tr>
    </table>
</div>
