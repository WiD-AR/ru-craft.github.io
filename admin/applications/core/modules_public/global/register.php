 ...
 * IP.Board v3.3.1
 * Register
 * Last Updated: $Date: 2012-02-21 04:48:22 -0500 (Tue, 21 Feb 2012) $
 * </pre>
 *
 * @author 		$Author $
				...
				if ( !empty( $chosenPackages ) )
				{
					...
					foreach ( $chosenPackages as $itemID )
					{
						...
						$items[] = array(
							...
							'renew_term'	=> $packages[ $itemID ]['p_renewals'],
							'renew_units'	=> $packages[ $itemID ]['p_renewal_unit'],
							'renew_cost'	=> $packages[ $itemID ]['p_renewal_price'] ? $packages[ $itemID ]['p_renewal_price'] : $packages[ $itemID ]['p_base_price'],
