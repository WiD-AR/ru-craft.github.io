 ...
 * Ouput format: HTML
 * (Matt Mecham)
 * Last Updated: $Date: 2012-01-24 11:15:12 -0500 (Tue, 24 Jan 2012) $
 * </pre>
 *
...
class htmlOutput extends coreOutput implements interface_output 
{
	...
	protected function html_fetchCopyright()
	{
        ...
        else
        {
        	$copyright = "<!-- Copyright Information -->
        				  <p id='copyright'>
        				  	Система для сообществ <a href='http://www.invisionpower.com/products/board/' title='Community Forum Software by Invision Power Services'>IP.Board{$version}</a>";
        	...
        	$copyright .= "<div style='display:none;'><a title='Приложения, скины, хуки для IP.Board' href='http://ipbmaster.ru/'>Всё для IPB</a></div></p>\n\t\t<!-- / Copyright -->";
        }
	...
	public function html_showDebugInfo()
    {
       ...
       if ($this->settings['debug_level'] >= 2)
       {
			...
			$stats .= "<br />\n<div class='tableborder'>\n<div class='subtitle'>Дополнительная информация</div><div class='row1' style='padding:6px'>\n";
