 ...
 * IP.Board v3.3.1
 * Setup skin file
 * Last Updated: $Date: 2012-03-14 08:31:51 -0400 (Wed, 14 Mar 2012) $
 * </pre>
 *
 * @author 		$Author: mark $
...
EOF;
	...
	else
	{
		...
		<span style='color:red; font-weight: bold;'>Значение на вашей системе: {$_memLimit}.<br />Пожалуйста свяжитесь с вашим хостинг-провайдером для увеличения параметра до {$_recLimit}M.</span>
EOF;
	}
}
else
...
$IPBHTML .= <<<EOF
	...
	<div class='message unspecific note'>
		<a href='http://external.iblink.ru/lk' target='_blank'>Как найти ключ лицензии</a>
	</div>
...
$IPBHTML .= <<<EOF
    <div class='message unspecific note'>
    	Если вам нужна помощь по работе с мастером установки, то обратитесь к <a href='http://wiki.iblink.ru' target='_blank'><b>документации</b></a>.
    </div>
</div>
<br />
<div class='message unspecified'>
...
{
	$IPBHTML .= <<<EOF
					<li><a href='http://external.iblink.ru/installation-guide' target='_blank'><b>Руководство по установке</b></a></li>
EOF;
}
...
else
{
	$HTML .= <<<EOF
	<div style='float: right'>
		<input type='submit' class='nav_button' value='Продолжить &rarr;' />
</div>
EOF;
}
